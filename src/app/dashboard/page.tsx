                        ...
                        <main className="p-6 sm:p-10 space-y-6">
                            <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                                <div className="mr-6">
                                    ...
                                    <h2 className="text-gray-600 ml-0.5">Health Connect Admin</h2>
                                </div>
                            ...
                            <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                                <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <span className="block text-gray-500">Pacientes</span>
                                    </div>
                                </div>
                                <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <span className="block text-gray-500">Pacientes diarios</span>
                                    </div>
                                </div>
                                <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <span className="block text-gray-500">Pacientes en espera</span>
                                    </div>
                                </div>
                                <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <span className="block text-gray-500">Pacientes Atendidos</span>
                                    </div>
                                </div>
                            </section>
                            <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
                                <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
                                    <div className="px-6 py-5 font-semibold border-b border-gray-100">Pacientes atendidos mensualmente</div>
                                    <div className="p-4 flex-grow">
                                        <div className="flex items-center justify-center h-full px-4 text-gray-400 text-3xl font-semibold bg-gray-100 border-2 border-gray-200 border-dashed rounded-md">
                                            Chart
                                            {/* <Image src="/images/TimeLinePacientes.png" alt="Logo" width={928} height={194} style={{maxWidth:'104%'}} /> */}
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                ...
                                <div className="row-span-3 bg-white shadow rounded-lg">
                                    <div className="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
                                        <span>Pacientes esperando Examenes</span>
                                ...
                                <div className="flex flex-col row-span-3 bg-white shadow rounded-lg">
                                    <div className="px-6 py-5 font-semibold border-b border-gray-100">Examenes realizados en el mes</div>
                                    <div className="p-4 flex-grow">
