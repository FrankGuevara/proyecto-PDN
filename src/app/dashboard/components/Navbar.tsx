...
const Navbar = () => {
    return (
        <header className="header sticky top-0 bg-white shadow-md flex items-center  px-8 py-02">
            ...
            <h1 className="w-3/12">
                <a href="">
                <Image className="block" src="/images/HealthConnect.webp" alt="Logo" width={50} height={50} />
                </a>
            </h1>

            <nav className="nav font-semibold text-lg">
                <ul className="flex items-center">
                    <li className="p-4 border-b-2 border-blue-900 border-opacity-0 hover:border-opacity-100 hover:text-blue-900 duration-200 cursor-pointer active">
                        <a href="">Inicio</a>
                    </li>
                    <li className="p-4 border-b-2 border-blue-900 border-opacity-0 hover:border-opacity-100 hover:text-blue-900 duration-200 cursor-pointer">
                        <a href="">Mis Citas</a>
                    </li>
                    <li className="p-4 border-b-2 border-blue-900 border-opacity-0 hover:border-opacity-100 hover:text-blue-900 duration-200 cursor-pointer">
                        <a href="">Recetario</a>
